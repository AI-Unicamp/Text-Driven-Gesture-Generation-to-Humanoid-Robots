...
class BVHAnalyzer(object):
    ...
    def _setup_plot(self):
        ...
        self.r_wrist_trail_line, = self.ax_skeleton.plot([], [], [], c='red', lw=2, alpha=0.7, label='Right Wrist')
        self.l_wrist_trail_line, = self.ax_skeleton.plot([], [], [], c='green', lw=2, alpha=0.7, label='Left Wrist')
        self.frame_text = self.ax_skeleton.set_title('')

        # Setup trajectory plots
        self.full_traj_line_r, = self.ax_trajectory.plot([], [], [], c='red', lw=2, alpha=0.7, label='Right')
        self.full_traj_line_l, = self.ax_trajectory.plot([], [], [], c='green', lw=2, alpha=0.7, label='Left')

        # Setup RIGHT WRIST time series plots
        self.r_x_line, = self.ax_r_x.plot([], [], 'red', lw=2)
        self.r_y_line, = self.ax_r_y.plot([], [], 'red', lw=2)
        self.r_z_line, = self.ax_r_z.plot([], [], 'red', lw=2)
        
        # Setup LEFT WRIST time series plots
        self.l_x_line, = self.ax_l_x.plot([], [], 'green', lw=2)
        self.l_y_line, = self.ax_l_y.plot([], [], 'green', lw=2)
        self.l_z_line, = self.ax_l_z.plot([], [], 'green', lw=2)

        # Setup top-down views
        self.top_r_line, = self.ax_top_r.plot([], [], 'red', lw=2)
        self.top_r_marker, = self.ax_top_r.plot([], [], 'ro', markersize=8)
        self.top_l_line, = self.ax_top_l.plot([], [], 'green', lw=2)
        self.top_l_marker, = self.ax_top_l.plot([], [], 'go', markersize=8)
        
        # Setup 3D individual trajectories
        self.traj_3d_r_line, = self.ax_3d_r.plot([], [], [], 'red', lw=2, alpha=0.7)
        self.traj_3d_l_line, = self.ax_3d_l.plot([], [], [], 'green', lw=2, alpha=0.7)
    ...
    def _init_animation(self):
        ...
        self.ax_skeleton.legend(fontsize=8)
        self.ax_skeleton.set_title('BVH Skeleton', fontsize=12, fontweight='bold')
        ...
        self.ax_trajectory.set_title('Both Trajectories', fontsize=12, fontweight='bold')
        ...
        # RIGHT WRIST plots
        self.ax_r_x.set_title('Right Wrist - X vs Time', fontsize=11, fontweight='bold', color='darkred')
        ...
        self.ax_r_y.set_title('Right Wrist - Y vs Time', fontsize=11, fontweight='bold', color='darkred')
        ...
        self.ax_r_z.set_title('Right Wrist - Z vs Time', fontsize=11, fontweight='bold', color='darkred')
        ...
        # LEFT WRIST plots
        self.ax_l_x.set_title('Left Wrist - X vs Time', fontsize=11, fontweight='bold', color='darkgreen')
        ...
        self.ax_l_y.set_title('Left Wrist - Y vs Time', fontsize=11, fontweight='bold', color='darkgreen')
        ...
        self.ax_l_z.set_title('Left Wrist - Z vs Time', fontsize=11, fontweight='bold', color='darkgreen')
        ...
        # Setup top-down views
        self.ax_top_r.set_title('Right Wrist - Top View', fontsize=11, fontweight='bold', color='darkred')
        ...
        self.ax_top_l.set_title('Left Wrist - Top View', fontsize=11, fontweight='bold', color='darkgreen')
        ...
        # Setup 3D individual trajectories
        self.ax_3d_r.set_title('Right 3D Trajectory', fontsize=11, fontweight='bold', color='darkred')
        ...
        self.ax_3d_l.set_title('Left 3D Trajectory', fontsize=11, fontweight='bold', color='darkgreen')
    ...
    def export_time_series_plots(self):
        ...
        plt.plot(times, self.r_wrist_full_history[:,0], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - X Position vs Time', fontsize=18, fontweight='bold')
        ...
        # Right Y vs Time
        plt.figure(figsize=(12, 8))
        plt.plot(times, self.r_wrist_full_history[:,1], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - Y Position vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        ...
        # Right Z vs Time
        plt.figure(figsize=(12, 8))
        plt.plot(times, self.r_wrist_full_history[:,2], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - Z Position vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        ...
        # Left X vs Time
        plt.figure(figsize=(12, 8))
        plt.plot(times, self.l_wrist_full_history[:,0], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - X Position vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('X Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        ...
        # Left Y vs Time
        plt.figure(figsize=(12, 8))
        plt.plot(times, self.l_wrist_full_history[:,1], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - Y Position vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('Y Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        ...
        # Left Z vs Time
        plt.figure(figsize=(12, 8))
        plt.plot(times, self.l_wrist_full_history[:,2], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - Z Position vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('Z Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        ...
        plt.plot(times, self.r_wrist_full_history[:,0], 'red', lw=3, alpha=0.8, label='Right Wrist')
        plt.plot(times, self.l_wrist_full_history[:,0], 'green', lw=3, alpha=0.8, label='Left Wrist')
        plt.title('X Position Comparison - Both Wrists vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('X Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        ...
        plt.figure(figsize=(15, 8))
        plt.plot(times, self.r_wrist_full_history[:,1], 'red', lw=3, alpha=0.8, label='Right Wrist')
        plt.plot(times, self.l_wrist_full_history[:,1], 'green', lw=3, alpha=0.8, label='Left Wrist')
        plt.title('Y Position Comparison - Both Wrists vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('Y Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.legend(fontsize=12)
        ...
        plt.figure(figsize=(15, 8))
        plt.plot(times, self.r_wrist_full_history[:,2], 'red', lw=3, alpha=0.8, label='Right Wrist')
        plt.plot(times, self.l_wrist_full_history[:,2], 'green', lw=3, alpha=0.8, label='Left Wrist')
        plt.title('Z Position Comparison - Both Wrists vs Time', fontsize=18, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=14)
        plt.ylabel('Z Position (m)', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.legend(fontsize=12)
        ...
        plt.subplot(3, 1, 1)
        plt.plot(times, self.r_wrist_full_history[:,0], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - X Position vs Time', fontsize=14, fontweight='bold')
        plt.ylabel('X Position (m)', fontsize=12)
        plt.grid(True, alpha=0.3)
        
        plt.subplot(3, 1, 2)
        plt.plot(times, self.r_wrist_full_history[:,1], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - Y Position vs Time', fontsize=14, fontweight='bold')
        plt.ylabel('Y Position (m)', fontsize=12)
        plt.grid(True, alpha=0.3)
        
        plt.subplot(3, 1, 3)
        plt.plot(times, self.r_wrist_full_history[:,2], 'red', lw=3, alpha=0.8)
        plt.title('Right Wrist - Z Position vs Time', fontsize=14, fontweight='bold')
        ...
        plt.subplot(3, 1, 1)
        plt.plot(times, self.l_wrist_full_history[:,0], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - X Position vs Time', fontsize=14, fontweight='bold')
        plt.ylabel('X Position (m)', fontsize=12)
        plt.grid(True, alpha=0.3)
        
        plt.subplot(3, 1, 2)
        plt.plot(times, self.l_wrist_full_history[:,1], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - Y Position vs Time', fontsize=14, fontweight='bold')
        plt.ylabel('Y Position (m)', fontsize=12)
        plt.grid(True, alpha=0.3)
        
        plt.subplot(3, 1, 3)
        plt.plot(times, self.l_wrist_full_history[:,2], 'green', lw=3, alpha=0.8)
        plt.title('Left Wrist - Z Position vs Time', fontsize=14, fontweight='bold')
        plt.xlabel('Time (s)', fontsize=12)
        plt.ylabel('Z Position (m)', fontsize=12)
        plt.grid(True, alpha=0.3)
        ...
        ax.set_title('Right Wrist - Complete 3D Trajectory', fontsize=16, fontweight='bold')
        ...
        ax.plot(self.l_wrist_full_history[:,0], self.l_wrist_full_history[:,1], self.l_wrist_full_history[:,2], 
                'green', lw=3, alpha=0.8)
        ax.set_xlabel('X Position (m)', fontsize=12)
        ax.set_ylabel('Y Position (m)', fontsize=12)
        ax.set_zlabel('Z Position (m)', fontsize=12)
        ax.set_title('Left Wrist - Complete 3D Trajectory', fontsize=16, fontweight='bold')
        ...
        ax = fig.add_subplot(111, projection='3d')
        ax.plot(self.r_wrist_full_history[:,0], self.r_wrist_full_history[:,1], self.r_wrist_full_history[:,2], 
                'red', lw=3, alpha=0.8, label='Right Wrist')
        ax.plot(self.l_wrist_full_history[:,0], self.l_wrist_full_history[:,1], self.l_wrist_full_history[:,2], 
                'green', lw=3, alpha=0.8, label='Left Wrist')
        ax.set_xlabel('X Position (m)', fontsize=12)
        ax.set_ylabel('Y Position (m)', fontsize=12)
        ax.set_zlabel('Z Position (m)', fontsize=12)
        ax.set_title('Both Wrists - Complete 3D Trajectories', fontsize=16, fontweight='bold')
        ax.legend()
    ...
    def run(self, export_only=False):
        ...
        if export_only:
            print("Export-only mode: plots saved, skipping animation.")
            return
